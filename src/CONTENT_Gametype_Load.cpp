...
void GAMETYPE_Load() {
  ...
  DIR* dip;
  if ((dip = opendir("base/c64")) != NULL) {
    closedir(dip);
    GV.DirC64Exists = true;
  }
  if ((dip = opendir("base/default")) != NULL) {
    closedir(dip);
    GV.DirDefaultExists = true;
  }
  if ((dip = opendir("base/amiga")) != NULL) {
    closedir(dip);
    GV.DirAmigaExists = true;
  }
  ...
  snprintf(FileName.PlayerDefinition, sizeof(char) * 128,
           "base/default/Player.txt");
  snprintf(FileName.Enemies, sizeof(char) * 128, "base/default/Enemies.png");
  snprintf(FileName.EnemiesDefinition, sizeof(char) * 128,
           "base/default/Enemies.txt");
  snprintf(FileName.PowerUp, sizeof(char) * 128, "base/default/PowerUp.png");
  snprintf(FileName.PowerUpDefinition, sizeof(char) * 128,
           "base/default/PowerUp.txt");
  snprintf(FileName.Interface, sizeof(char) * 128, "base/Interface.png");
  snprintf(FileName.Font, sizeof(char) * 128, "base/Font.png");

  snprintf(FileName.WavChunk[AUDIO_DISK], sizeof(char) * 128,
           "base/audio/disk.wav");
  snprintf(FileName.WavChunk[AUDIO_JUMP], sizeof(char) * 128,
           "base/audio/jump.wav");
  snprintf(FileName.WavChunk[AUDIO_STOMP], sizeof(char) * 128,
           "base/audio/stomp.wav");
  snprintf(FileName.WavChunk[AUDIO_KILLED], sizeof(char) * 128,
           "base/audio/died.wav");
  snprintf(FileName.WavChunk[AUDIO_DING], sizeof(char) * 128,
           "base/audio/ding.wav");
  snprintf(FileName.WavChunk[AUDIO_CLICK], sizeof(char) * 128,
           "base/audio/click.wav");
  snprintf(FileName.WavChunk[AUDIO_GOTPOWERUP], sizeof(char) * 128,
           "base/audio/morphing.wav");
  snprintf(FileName.WavChunk[AUDIO_SHOOT], sizeof(char) * 128,
           "base/audio/shoot.wav");
  snprintf(FileName.WavChunk[AUDIO_CRACK], sizeof(char) * 128,
           "base/audio/crack.wav");
  ...
  if (GV.GameType == TYPE_AMIGA && GV.DirAmigaExists) {
    ...
    snprintf(FileName.PlayerDefinition, sizeof(char) * 128,
             "base/amiga/Player.txt");
    snprintf(FileName.Enemies, sizeof(char) * 128, "base/amiga/Enemies.png");
    snprintf(FileName.EnemiesDefinition, sizeof(char) * 128,
             "base/amiga/Enemies.txt");
    snprintf(FileName.PowerUp, sizeof(char) * 128, "base/amiga/PowerUp.png");
    snprintf(FileName.PowerUpDefinition, sizeof(char) * 128,
             "base/amiga/PowerUp.txt");

    snprintf(FileName.BGM_Title, sizeof(char) * 128, "base/amiga/title.mod");
    snprintf(FileName.BGM_Outdoors, sizeof(char) * 128,
             "base/amiga/outdoors.mod");
    snprintf(FileName.BGM_Indoors, sizeof(char) * 128,
             "base/amiga/indoors.mod");
  }
