...
void ENEMY_Draw(int EnemyNumber) {
  ...
  if (Enemy[EnemyNumber].inUse && Enemy[EnemyNumber].Active) {
    ...
    if (Enemy[EnemyNumber].Type < 16) {
      SrcRect.x =
          Enemy_Type[Enemy[EnemyNumber].Type]
              .FrameX[Enemy[EnemyNumber].Direction][AnimationFrame][NPC_ALIVE];
      SrcRect.y =
          Enemy_Type[Enemy[EnemyNumber].Type]
              .FrameY[Enemy[EnemyNumber].Direction][AnimationFrame][NPC_ALIVE];
      SrcRect.w =
          Enemy_Type[Enemy[EnemyNumber].Type]
              .FrameW[Enemy[EnemyNumber].Direction][AnimationFrame][NPC_ALIVE];
      SrcRect.h =
          Enemy_Type[Enemy[EnemyNumber].Type]
              .FrameH[Enemy[EnemyNumber].Direction][AnimationFrame][NPC_ALIVE];

      if (!Enemy[EnemyNumber].Alive) {
        SrcRect.x = Enemy_Type[Enemy[EnemyNumber].Type]
                        .FrameX[NPC_DEAD][NPC_DEAD][NPC_DEAD];
        SrcRect.y = Enemy_Type[Enemy[EnemyNumber].Type]
                        .FrameY[NPC_DEAD][NPC_DEAD][NPC_DEAD];
        SrcRect.w = Enemy_Type[Enemy[EnemyNumber].Type]
                        .FrameW[NPC_DEAD][NPC_DEAD][NPC_DEAD];
        SrcRect.h = Enemy_Type[Enemy[EnemyNumber].Type]
