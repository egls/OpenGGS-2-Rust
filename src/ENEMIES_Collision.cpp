...
bool ENEMY_Collision_Down(int EnemyNumber) {
  ...
  if (Enemy[EnemyNumber].JumpVelocity < 0) {
    if (TileType[StageC64.TileNumber[(
                     int)((Enemy[EnemyNumber].PosX -
                           Enemy_Type[Enemy[EnemyNumber].Type].ColWidthHalf) /
                          TS.Tile_Width)][(int)(Enemy[EnemyNumber].PosY /
                                                TS.Tile_Height)]]
            .Solid ||  // CHECK BOTTOM-LEFT
        TileType[StageC64.TileNumber[(int)(Enemy[EnemyNumber].PosX /
                                           TS.Tile_Width)][(
                     int)(Enemy[EnemyNumber].PosY / TS.Tile_Height)]]
  ...
  // DON'T STOP JUMPERS!
  if (Enemy_Type[Enemy[EnemyNumber].Type].JumpStrength > 0) {
    ReturnValue = false;
  }
...
bool ENEMY_Collision_Left(int EnemyNumber) {
  ...
  if (!TileType[StageC64.TileNumber[(
           ...
           .Solid &&  // CHECK BOTTOM-LEFT
      TileType[StageC64
                   .TileNumber[(int)(Enemy[EnemyNumber].PosX / TS.Tile_Width)]
                              [(int)(Enemy[EnemyNumber].PosY / TS.Tile_Height)]]
          .Solid &&  // CHECK BOTTOM-CENTER
      TileType[StageC64.TileNumber[(
                   int)((Enemy[EnemyNumber].PosX +
  ...
  if (TileType[StageC64.TileNumber[(
                   int)((Enemy[EnemyNumber].PosX -
                         Enemy_Type[Enemy[EnemyNumber].Type].ColWidthHalf - 1) /
                        TS.Tile_Width)][(int)((Enemy[EnemyNumber].PosY) /
                                              TS.Tile_Height) -
                                        1]]
          .Solid)  // CHECK BOTTOM-LEFT
  ...
  if (TileType[StageC64.TileNumber[(
                   int)((Enemy[EnemyNumber].PosX -
                         Enemy_Type[Enemy[EnemyNumber].Type].ColWidthHalf - 1) /
                        TS.Tile_Width)][(
                   int)((Enemy[EnemyNumber].PosY -
                         Enemy_Type[Enemy[EnemyNumber].Type].ColHeight) /
                        TS.Tile_Height)]]
