...
void STAGE_Save(int StageNumber) {
  ...
  FILE* Stage_File;
  ImportStage_Struct
      ExportStage;  // all the data of one stage (currently approx 35KB per stage!)
  ...
  for (y = 0; y < 30; y++) {
    for (x = 0; x < 256; x++) {
      ...
      ExportStage.StartPositionX[0] =
          StageCache_C64.StartPositionX[StageNumber][0];
      ExportStage.StartPositionY[0] =
          StageCache_C64.StartPositionY[StageNumber][0];
      ExportStage.StartPositionX[1] =
          StageCache_C64.StartPositionX[StageNumber][1];
      ExportStage.StartPositionY[1] =
          StageCache_C64.StartPositionY[StageNumber][1];
      ExportStage.StartPositionX[2] =
          StageCache_C64.StartPositionX[StageNumber][2];
      ExportStage.StartPositionY[2] =
          StageCache_C64.StartPositionY[StageNumber][2];
      ExportStage.StartPositionX[3] =
          StageCache_C64.StartPositionX[StageNumber][3];
      ExportStage.StartPositionY[3] =
          StageCache_C64.StartPositionY[StageNumber][3];
    }
  }
  ExportStage.BackgroundColour = StageCache_C64.BackgroundColour[StageNumber];
  ExportStage.TileType =
      StageCache_C64.TileType
          [StageNumber];  // above ground, underground, different colours...
  ...
  ExportStage.PlatformPathLength =
      StageCache_C64.PlatformPathLength[StageNumber];
  ExportStage.PlatformMovePos = StageCache_C64.PlatformMovePos[StageNumber];
  ExportStage.Substage_StartPositionX =
      StageCache_C64.Substage_StartPositionX[StageNumber];
  ExportStage.Substage_StartPositionY =
      StageCache_C64.Substage_StartPositionY[StageNumber];
  ExportStage.Substage_PlatformInUse =
      StageCache_C64.Substage_PlatformInUse[StageNumber];
  ExportStage.Substage_PlatformX =
      StageCache_C64.Substage_PlatformX[StageNumber];
  ExportStage.Substage_PlatformY =
      StageCache_C64.Substage_PlatformY[StageNumber];
  ExportStage.Substage_PlatformType =
      StageCache_C64.Substage_PlatformType[StageNumber];
  ExportStage.Substage_PlatformDirection =
      StageCache_C64.Substage_PlatformDirection[StageNumber];
  ExportStage.Substage_PlatformPathlength =
      StageCache_C64.Substage_PlatformPathlength[StageNumber];
  ExportStage.Substage_PlatformMovePos =
      StageCache_C64.Substage_PlatformMovePos[StageNumber];
  for (y = 0; y < 40; y++) {
    for (x = 0; x < 30; x++) {
      ExportStage.Substage_Array[x][y] =
          StageCache_C64.Substage_Array[StageNumber][x][y];
    }
  }
  ...
  for (x = 0; x < MAX_NUM_ENEMIES; x++) {
    ...
    ExportStage.Enemy_Direction[x] =
        StageCache_C64.Enemy_Direction[StageNumber][x];
    ExportStage.Enemy_PosX[x] =
        StageCache_C64.Enemy_PosX[StageNumber][x] * TS.Tile_Width;
    ExportStage.Enemy_PosY[x] =
        StageCache_C64.Enemy_PosY[StageNumber][x] * TS.Tile_Height;
  }
  ...
  if (Stage_File != NULL) {
    fseek(Stage_File, StageNumber * sizeof(ExportStage),
          SEEK_SET);  // MOVE TO StageNumber
...
void STAGES_Import() {
  ...
  if (Stages_File != NULL) {
    ...
    for (StageNumber = 0; StageNumber < 38; StageNumber++) {
      ...
      for (y = 0; y < 30; y++) {
        for (x = 0; x < 256; x++) {
          StageCache_C64.TileNumber[StageNumber][x][y] =
              ImportStage.Array[x][y];
          StageCache_C64.StartPositionX[StageNumber][0] =
              ImportStage.StartPositionX[0];
          StageCache_C64.StartPositionY[StageNumber][0] =
              ImportStage.StartPositionY[0];
          StageCache_C64.StartPositionX[StageNumber][1] =
              ImportStage.StartPositionX[1];
          StageCache_C64.StartPositionY[StageNumber][1] =
              ImportStage.StartPositionY[1];
          StageCache_C64.StartPositionX[StageNumber][2] =
              ImportStage.StartPositionX[2];
          StageCache_C64.StartPositionY[StageNumber][2] =
              ImportStage.StartPositionY[2];
          StageCache_C64.StartPositionX[StageNumber][3] =
              ImportStage.StartPositionX[3];
          StageCache_C64.StartPositionY[StageNumber][3] =
              ImportStage.StartPositionY[3];
        }
      }
      StageCache_C64.BackgroundColour[StageNumber] =
          ImportStage.BackgroundColour;
      StageCache_C64.TileType[StageNumber] =
          ImportStage
              .TileType;  // above ground, underground, different colours...
      ...
      StageCache_C64.PlatformDirection[StageNumber] =
          ImportStage.PlatformDirection;
      StageCache_C64.PlatformPathLength[StageNumber] =
          ImportStage.PlatformPathLength;
      StageCache_C64.PlatformMovePos[StageNumber] = ImportStage.PlatformMovePos;
      StageCache_C64.Substage_StartPositionX[StageNumber] =
          ImportStage.Substage_StartPositionX;
      StageCache_C64.Substage_StartPositionY[StageNumber] =
          ImportStage.Substage_StartPositionY;

      StageCache_C64.Substage_PlatformInUse[StageNumber] =
          ImportStage.Substage_PlatformInUse;
      StageCache_C64.Substage_PlatformX[StageNumber] =
          ImportStage.Substage_PlatformX;
      StageCache_C64.Substage_PlatformY[StageNumber] =
          ImportStage.Substage_PlatformY;
      StageCache_C64.Substage_PlatformType[StageNumber] =
          ImportStage.Substage_PlatformType;
      StageCache_C64.Substage_PlatformDirection[StageNumber] =
          ImportStage.Substage_PlatformDirection;
      StageCache_C64.Substage_PlatformPathlength[StageNumber] =
          ImportStage.Substage_PlatformPathlength;
      StageCache_C64.Substage_PlatformMovePos[StageNumber] =
          ImportStage.Substage_PlatformMovePos;

      for (y = 0; y < 40; y++) {
        for (x = 0; x < 30; x++) {
          StageCache_C64.Substage_Array[StageNumber][x][y] =
              ImportStage.Substage_Array[x][y];
        }
      }
      ...
      for (x = 0; x < MAX_NUM_ENEMIES; x++) {
        ...
        StageCache_C64.Enemy_Direction[StageNumber][x] =
            ImportStage.Enemy_Direction[x];
        StageCache_C64.Enemy_PosX[StageNumber][x] =
            (int)(ImportStage.Enemy_PosX[x] / TS.Tile_Width);
        StageCache_C64.Enemy_PosY[StageNumber][x] =
            (int)(ImportStage.Enemy_PosY[x] / TS.Tile_Height);
      }
      ...
      if (GV.RandomLevels) {
        LOOP_Editor_Stages_Create(StageCache_C64.BackgroundColour[StageNumber],
                                  true, true, false);
        STAGE_Copy_To_Cache(StageNumber);
      }
      // IF RANDOMIZED LEVELS, CREATE A RANDOM LEVEL SET
...
void STAGE_Copy_To_Cache(int StageNumber) {
  ...
  for (x = 0; x < 4; x++) {
    StageCache_C64.StartPositionX[StageNumber][x] =
        ME.StartPositionX_Tile[x] * TS.Tile_Width;
    StageCache_C64.StartPositionY[StageNumber][x] =
        ME.StartPositionY_Tile[x] * TS.Tile_Height;
  }

  for (x = 0; x < MAX_NUM_ENEMIES; x++) {
    StageCache_C64.Enemy_PosX[StageNumber][x] =
        ME.Enemy_PosX[x];  // EDITOR HAS ENEMY POSITION ON TILES NOT PIXELS
    StageCache_C64.Enemy_PosY[StageNumber][x] =
        ME.Enemy_PosY[x];  // EDITOR HAS ENEMY POSITION ON TILES NOT PIXELS
  ...
  StageCache_C64.PlatformPathLength[StageNumber] =
      ME.Platform_Start_Y - ME.Platform_End_Y;
...
void STAGE_Load(int StageNumber, int CheckPointNumber, bool ShowSplashScreen,
  ...
  for (x = 1; x < 10; x++) {
    Sprite_PowerUp[x].Active = false;
  }
  for (x = 1; x < 20; x++) {
    Sprite_SmallCoin[x].Active = false;
  }
  for (x = 1; x < 30; x++) {
  ...
  while (StageC64.StageWidthPixels < GV.Screen_Width) {
  ...
  for (x = 0; x < 4; x++) {
    BackGroundElements.TubePosX[x] =
        (x * 500) + rand() % 400;  // DISTRIBUTE THE TUBE OVER THE MAP
    BackGroundElements.TubeFire[x] = rand() % 2;
  }

  PC.PosX = StageCache_C64.StartPositionX[StageNumber][CheckPointNumber];
  PC.PosY = StageCache_C64.StartPositionY[StageNumber][CheckPointNumber] +
            TS.Tile_Height;
  ...
  Platform.End_Y =
      Platform.Start_Y -
      (StageCache_C64.PlatformPathLength[StageNumber] * TS.Tile_Height);
  Platform.PosX = Platform.Start_X;
  Platform.PosY = Platform.Start_Y;

  if (ShowSplashScreen && GV.SplashscreensEnabled) {
    LOOP_Gameloop_Splashscreen();
  }

  if (GV.Mode == MODE_GAMELOOP && StageC64.BackgroundColour == 0) {
    AUDIO_Music_Play(MUSIC_OUTDOORS);
  }
  if (GV.Mode == MODE_GAMELOOP && StageC64.BackgroundColour == 1) {
    AUDIO_Music_Play(MUSIC_INDOORS);
  }
  if (GV.Mode == MODE_MENU) {
...
void STAGE_Copy_To_StageC64() {
  ...
  if (ME.Stage == PC.Stage) {
    ...
    for (x = 0; x < MAX_NUM_ENEMIES; x++) {
      Enemy[x].PosX =
          ME.Enemy_PosX[x] *
          TS.Tile_Width;  // EDITOR HAS ENEMY POSITION ON TILES NOT PIXELS
      Enemy[x].PosY =
          ME.Enemy_PosY[x] *
          TS.Tile_Height;  // EDITOR HAS ENEMY POSITION ON TILES NOT PIXELS
  ...
  if ((dir = opendir("base/stages/")) != NULL) {
    ...
    while ((ent = readdir(dir)) != NULL) {
      if (strncmp("..", ent->d_name, 2) != 0 &&
        ...
        snprintf(FileName.Stage[x], sizeof(char) * 128, "base/stages/%s",
                 ent->d_name);
...
void STAGES_Import_RANDOM_Modules() {
  ...
  if (Stages_File != NULL) {
    ...
    for (StageNumber = 0; StageNumber < 38; StageNumber++) {
      ...
      {
        for (x = 0; x < MAX_NUM_ENEMIES_MODULE;
             x++)  // MAXIMUM ENEMIES PER MODULE
        {
      ...
      {
        for (z = 0; z < MAX_NUM_ENEMIES;
             z++)  // CYCLE THROUGH ALL ENEMIES WITHIN A STAGE
        {
          if (StageCache_C64.Enemy_InUse[a + 1][z] ==
              1)  //+1, BECAUSE IT STARTS AT STAGE 1
          {

            ModuleInStage =
                StageCache_C64.Enemy_PosX[a + 1][z] /
                32;  // THE NUMBER OF THE MODULE WITHIN THE STAGE (0-7)
            ModuleCounter = ModuleInStage + (a * 8);  // NUMBER OF THE MODULE
            SlotFound = false;
            EnemyInModuleCounter = 0;
            while (!SlotFound && EnemyInModuleCounter < 5) {
              if (Stage_Random_Module_Outdoors[ModuleCounter]
                      .Enemy_InUse[EnemyInModuleCounter] == 0) {
                EnemySlot = EnemyInModuleCounter;
                Stage_Random_Module_Outdoors[ModuleCounter]
                    .Enemy_InUse[EnemySlot] =
                    StageCache_C64.Enemy_InUse[a + 1][z];
                Stage_Random_Module_Outdoors[ModuleCounter]
                    .Enemy_PosX[EnemySlot] =
                    StageCache_C64.Enemy_PosX[a + 1][z] - (ModuleInStage * 32);
                Stage_Random_Module_Outdoors[ModuleCounter]
                    .Enemy_PosY[EnemySlot] =
                    StageCache_C64.Enemy_PosY[a + 1][z];
                Stage_Random_Module_Outdoors[ModuleCounter]
                    .Enemy_Direction[EnemySlot] =
                    StageCache_C64.Enemy_Direction[a + 1][z];
                Stage_Random_Module_Outdoors[ModuleCounter]
                    .Enemy_Type[EnemySlot] =
                    StageCache_C64.Enemy_Type[a + 1][z];
                SlotFound = true;
              }
      ...
      for (a = 0; a < 16; a++)  // 16 STAGES
      {
        for (z = 0; z < MAX_NUM_ENEMIES;
             z++)  // CYCLE THROUGH ALL ENEMIES WITHIN A STAGE
        {
          if (StageCache_C64.Enemy_InUse[a + 17][z] ==
              1)  //+17, BECAUSE IT STARTS AT STAGE 17
          {
            ModuleInStage =
                StageCache_C64.Enemy_PosX[a + 17][z] /
                32;  // THE NUMBER OF THE MODULE WITHIN THE STAGE (0-7)
            ModuleCounter = ModuleInStage + (a * 8);  // NUMBER OF THE MODULE
            SlotFound = false;
            EnemyInModuleCounter = 0;
            while (!SlotFound && EnemyInModuleCounter < 5) {
              if (Stage_Random_Module_Indoors[ModuleCounter]
                      .Enemy_InUse[EnemyInModuleCounter] == 0) {
                EnemySlot = EnemyInModuleCounter;
                Stage_Random_Module_Indoors[ModuleCounter]
                    .Enemy_InUse[EnemySlot] =
                    StageCache_C64.Enemy_InUse[a + 17][z];
                Stage_Random_Module_Indoors[ModuleCounter]
                    .Enemy_PosX[EnemySlot] =
                    StageCache_C64.Enemy_PosX[a + 17][z] - (ModuleInStage * 32);
                Stage_Random_Module_Indoors[ModuleCounter]
                    .Enemy_PosY[EnemySlot] =
                    StageCache_C64.Enemy_PosY[a + 17][z];
                Stage_Random_Module_Indoors[ModuleCounter]
                    .Enemy_Direction[EnemySlot] =
                    StageCache_C64.Enemy_Direction[a + 17][z];
                Stage_Random_Module_Indoors[ModuleCounter]
                    .Enemy_Type[EnemySlot] =
                    StageCache_C64.Enemy_Type[a + 17][z];
                SlotFound = true;
              }
              EnemyInModuleCounter++;
            }
      ...
      for (z = 0; z < MAX_NUM_ENEMIES;
           z++)  // CYCLE THROUGH ALL ENEMIES WITHIN A STAGE
      {
        if (StageCache_C64.Enemy_InUse[a + 34][z] ==
            1)  //+34, BECAUSE IT STARTS AT STAGE 34
        {
          ModuleInStage =
              StageCache_C64.Enemy_PosX[a + 34][z] /
              32;  // THE NUMBER OF THE MODULE WITHIN THE STAGE (0-7)
          ModuleCounter = ModuleInStage + (a * 8);  // NUMBER OF THE MODULE
          SlotFound = false;
          EnemyInModuleCounter = 0;
          while (!SlotFound && EnemyInModuleCounter < 5) {
            if (Stage_Random_Module_Outdoors_Exit[ModuleCounter]
                    .Enemy_InUse[EnemyInModuleCounter] == 0) {
              EnemySlot = EnemyInModuleCounter;
              Stage_Random_Module_Outdoors_Exit[ModuleCounter]
                  .Enemy_InUse[EnemySlot] =
                  StageCache_C64.Enemy_InUse[a + 34][z];
              Stage_Random_Module_Outdoors_Exit[ModuleCounter]
                  .Enemy_PosX[EnemySlot] =
                  StageCache_C64.Enemy_PosX[a + 34][z] - (ModuleInStage * 32);
              Stage_Random_Module_Outdoors_Exit[ModuleCounter]
                  .Enemy_PosY[EnemySlot] = StageCache_C64.Enemy_PosY[a + 34][z];
              Stage_Random_Module_Outdoors_Exit[ModuleCounter]
                  .Enemy_Direction[EnemySlot] =
                  StageCache_C64.Enemy_Direction[a + 34][z];
              Stage_Random_Module_Outdoors_Exit[ModuleCounter]
                  .Enemy_Type[EnemySlot] = StageCache_C64.Enemy_Type[a + 34][z];
              SlotFound = true;
            }
            EnemyInModuleCounter++;
          }
      ...
      for (z = 0; z < MAX_NUM_ENEMIES;
           z++)  // CYCLE THROUGH ALL ENEMIES WITHIN A STAGE
      {
        if (StageCache_C64.Enemy_InUse[a + 35][z] ==
            1)  //+35, BECAUSE IT STARTS AT STAGE 35
        {
          ModuleInStage =
              StageCache_C64.Enemy_PosX[a + 35][z] /
              32;  // THE NUMBER OF THE MODULE WITHIN THE STAGE (0-7)
          ModuleCounter = ModuleInStage + (a * 8);  // NUMBER OF THE MODULE
          SlotFound = false;
          EnemyInModuleCounter = 0;
          while (!SlotFound && EnemyInModuleCounter < 5) {
            if (Stage_Random_Module_Indoors_Exit[ModuleCounter]
                    .Enemy_InUse[EnemyInModuleCounter] == 0) {
              EnemySlot = EnemyInModuleCounter;
              Stage_Random_Module_Indoors_Exit[ModuleCounter]
                  .Enemy_InUse[EnemySlot] =
                  StageCache_C64.Enemy_InUse[a + 35][z];
              Stage_Random_Module_Indoors_Exit[ModuleCounter]
                  .Enemy_PosX[EnemySlot] =
                  StageCache_C64.Enemy_PosX[a + 35][z] - (ModuleInStage * 32);
              Stage_Random_Module_Indoors_Exit[ModuleCounter]
                  .Enemy_PosY[EnemySlot] = StageCache_C64.Enemy_PosY[a + 35][z];
              Stage_Random_Module_Indoors_Exit[ModuleCounter]
                  .Enemy_Direction[EnemySlot] =
                  StageCache_C64.Enemy_Direction[a + 35][z];
              Stage_Random_Module_Indoors_Exit[ModuleCounter]
                  .Enemy_Type[EnemySlot] = StageCache_C64.Enemy_Type[a + 35][z];
              SlotFound = true;
            }
            EnemyInModuleCounter++;
          }
      ...
      for (y = 0; y < 30; y++)  // 30 TILES HIGH
      {
        for (x = 0; x < 32; x++)  // 32 TILES WIDE
        {
          for (z = 0; z < 8; z++)  // 8 MODULES PER STAGE
          {
            for (a = 0; a < 16; a++)  // 16 STAGES
            {
              Stage_Random_Module_Outdoors[z + (8 * a)].TileNumber[x][y] =
                  StageCache_C64.TileNumber[a + 1][x + (z * 32)][y];
            }
          }
        }
      }
      ...
      for (y = 0; y < 30; y++)  // 30 TILES HIGH
      {
        for (x = 0; x < 32; x++)  // 32 TILES WIDE
        {
          for (z = 0; z < 8; z++)  // 8 MODULES PER STAGE
          {
            Stage_Random_Module_Outdoors_Exit[z].TileNumber[x][y] =
                StageCache_C64.TileNumber[34][x + (z * 32)][y];
          }
        }
      }
      ...
      for (y = 0; y < 30; y++)  // 30 TILES HIGH
      {
        for (x = 0; x < 32; x++)  // 32 TILES WIDE
        {
          for (z = 0; z < 8; z++)  // 8 MODULES PER STAGE
          {
            for (a = 0; a < 16; a++)  // 16 STAGES
            {
              Stage_Random_Module_Indoors[z + (8 * a)].TileNumber[x][y] =
                  StageCache_C64.TileNumber[a + 17][x + (z * 32)][y];
            }
          }
        }
      }
      ...
      for (y = 0; y < 30; y++)  // 30 TILES HIGH
      {
        for (x = 0; x < 32; x++)  // 32 TILES WIDE
        {
          for (z = 0; z < 8; z++)  // 8 MODULES PER STAGE
          {
            Stage_Random_Module_Indoors_Exit[z].TileNumber[x][y] =
                StageCache_C64.TileNumber[35][x + (z * 32)][y];
          }
        }
      }
    }
  ...
  for (z = 0; z < NUM_MODULES_OUTDOORS; z++)  // 16 MODULES
  {
    for (x = 0; x < MAX_NUM_ENEMIES_MODULE; x++)  // MAXIMUM ENEMIES PER MODULE
    {
      ...
      fprintf(f, "Dir: %d, ",
              Stage_Random_Module_Outdoors[z].Enemy_Direction[x]);
  ...
  for (z = 0; z < NUM_MODULES_OUTDOORS_EXITS; z++)  // 8 MODULES
  {
    for (x = 0; x < MAX_NUM_ENEMIES_MODULE; x++)  // MAXIMUM ENEMIES PER MODULE
    {
      fprintf(f, "%d/%d - ", z, x);
      fprintf(f, "InUse: %d, ",
              Stage_Random_Module_Outdoors_Exit[z].Enemy_InUse[x]);
      ...
      fprintf(f, "Dir: %d, ",
              Stage_Random_Module_Outdoors_Exit[z].Enemy_Direction[x]);
      fprintf(f, "Type: %d",
              Stage_Random_Module_Outdoors_Exit[z].Enemy_Type[x]);
      fprintf(f, "\n");
    }
  }
  ...
  for (z = 0; z < NUM_MODULES_INDOORS; z++)  // 16 MODULES
  {
    for (x = 0; x < MAX_NUM_ENEMIES_MODULE; x++)  // MAXIMUM ENEMIES PER MODULE
    {
      ...
      fprintf(f, "Dir: %d, ",
              Stage_Random_Module_Indoors[z].Enemy_Direction[x]);
  ...
  for (z = 0; z < NUM_MODULES_INDOORS_EXITS; z++)  // 8 MODULES
  {
    for (x = 0; x < MAX_NUM_ENEMIES_MODULE; x++)  // MAXIMUM ENEMIES PER MODULE
    {
      fprintf(f, "%d/%d - ", z, y);
      fprintf(f, "InUse: %d, ",
              Stage_Random_Module_Indoors_Exit[z].Enemy_InUse[x]);
      ...
      fprintf(f, "Dir: %d, ",
              Stage_Random_Module_Indoors_Exit[z].Enemy_Direction[x]);
