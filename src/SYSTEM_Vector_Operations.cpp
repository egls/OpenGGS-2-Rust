...
Vector3 vector_add(Vector3* v, Vector3* w) {
  Vector3 a = {v->x + w->x, v->y + w->y, v->z + w->z};
  return a;
}
...
Vector3 vector_cross(Vector3* v, Vector3* w) {
  Vector3 c = {v->y * w->z - v->z * w->y, v->z * w->x - v->x * w->z,
               v->x * w->y - v->y * w->x};
  return c;
}
...
int vector_direction_32(Vector3* v) {
  ...
  if (alpha >= 0 && alpha <= 6 && beta >= 84 && beta <= 96) {
    returnvalue = 0;
  }  //straight up
  if (int(alpha) == 180 && int(beta) == 90) {
    returnvalue = 16;
  }  // straight down (needed correction)

  if (alpha >= 6 && alpha <= 17 && beta >= 96 && beta <= 107) {
    returnvalue = 1;
  }
  if (alpha >= 17 && alpha <= 28 && beta >= 107 && beta <= 118) {
    returnvalue = 2;
  }
  if (alpha >= 28 && alpha <= 39 && beta >= 118 && beta <= 129) {
    returnvalue = 3;
  }
  if (alpha >= 39 && alpha <= 50 && beta >= 129 && beta <= 140) {
    returnvalue = 4;
  }
  if (alpha >= 50 && alpha <= 61 && beta >= 140 && beta <= 151) {
    returnvalue = 5;
  }
  if (alpha >= 61 && alpha <= 72 && beta >= 151 && beta <= 162) {
    returnvalue = 6;
  }
  if (alpha >= 72 && alpha <= 84 && beta >= 162 && beta <= 174) {
    returnvalue = 7;
  }
  if (alpha >= 84 && alpha <= 96 && beta >= 174 && beta <= 180) {
    returnvalue = 8;
  }  // right

  if (alpha >= 96 && alpha <= 107 && beta >= 162 && beta <= 174) {
    returnvalue = 9;
  }
  if (alpha >= 107 && alpha <= 118 && beta >= 151 && beta <= 162) {
    returnvalue = 10;
  }
  if (alpha >= 118 && alpha <= 129 && beta >= 140 && beta <= 151) {
    returnvalue = 11;
  }
  if (alpha >= 129 && alpha <= 140 && beta >= 129 && beta <= 140) {
    returnvalue = 12;
  }
  if (alpha >= 140 && alpha <= 151 && beta >= 118 && beta <= 129) {
    returnvalue = 13;
  }
  if (alpha >= 151 && alpha <= 162 && beta >= 107 && beta <= 118) {
    returnvalue = 14;
  }
  if (alpha >= 162 && alpha <= 174 && beta >= 96 && beta <= 107) {
    returnvalue = 15;
  }
  //if(alpha >= 174 && alpha <= 180 && beta >=  84 && beta <=  96) {returnvalue=16;} // straight down

  if (alpha >= 174 && alpha <= 180 && beta >= 84 && beta <= 96) {
    returnvalue = 16;
  }  // straight down (neededcorrection)

  if (alpha >= 162 && alpha <= 174 && beta >= 72 && beta <= 84) {
    returnvalue = 17;
  }
  if (alpha >= 151 && alpha <= 162 && beta >= 61 && beta <= 72) {
    returnvalue = 18;
  }
  if (alpha >= 140 && alpha <= 151 && beta >= 50 && beta <= 61) {
    returnvalue = 19;
  }
  if (alpha >= 129 && alpha <= 140 && beta >= 39 && beta <= 50) {
    returnvalue = 20;
  }
  if (alpha >= 118 && alpha <= 129 && beta >= 28 && beta <= 39) {
    returnvalue = 21;
  }
  if (alpha >= 107 && alpha <= 118 && beta >= 17 && beta <= 28) {
    returnvalue = 22;
  }
  if (alpha >= 96 && alpha <= 107 && beta >= 6 && beta <= 17) {
    returnvalue = 23;
  }
  if (alpha >= 84 && alpha <= 96 && beta >= 0 && beta <= 6) {
    returnvalue = 24;
  }  // left

  if (alpha >= 72 && alpha <= 84 && beta >= 6 && beta <= 17) {
    returnvalue = 25;
  }
  if (alpha >= 61 && alpha <= 72 && beta >= 17 && beta <= 28) {
    returnvalue = 26;
  }
  if (alpha >= 50 && alpha <= 61 && beta >= 28 && beta <= 39) {
    returnvalue = 27;
  }
  if (alpha >= 39 && alpha <= 50 && beta >= 39 && beta <= 50) {
    returnvalue = 28;
  }
  if (alpha >= 28 && alpha <= 39 && beta >= 50 && beta <= 61) {
    returnvalue = 29;
  }
  if (alpha >= 17 && alpha <= 28 && beta >= 61 && beta <= 72) {
    returnvalue = 30;
  }
  if (alpha >= 6 && alpha <= 17 && beta >= 72 && beta <= 84) {
    returnvalue = 31;
  }
...
void defineAngles() {
  ...
  angle[9] =
      1.5 * M_PI + 101 * (M_PI / 180);  // top of the circle// straight up
  angle[10] =
      1.5 * M_PI + 112 * (M_PI / 180);  // top of the circle// straight up
  angle[11] =
      1.5 * M_PI + 122 * (M_PI / 180);  // top of the circle// straight up
  angle[12] =
      1.5 * M_PI + 135 * (M_PI / 180);  // top of the circle// straight up
  angle[13] =
      1.5 * M_PI + 146 * (M_PI / 180);  // top of the circle// straight up
  angle[14] =
      1.5 * M_PI + 157 * (M_PI / 180);  // top of the circle// straight up
  angle[15] =
      1.5 * M_PI + 168 * (M_PI / 180);  // top of the circle// straight up
  angle[16] =
      1.5 * M_PI + 180 * (M_PI / 180);  // top of the circle// straight up
  angle[17] =
      1.5 * M_PI + 191 * (M_PI / 180);  // top of the circle// straight up
  angle[18] =
      1.5 * M_PI + 202 * (M_PI / 180);  // top of the circle// straight up
  angle[19] =
      1.5 * M_PI + 212 * (M_PI / 180);  // top of the circle// straight up
  angle[20] =
      1.5 * M_PI + 225 * (M_PI / 180);  // top of the circle// straight up
  angle[21] =
      1.5 * M_PI + 236 * (M_PI / 180);  // top of the circle// straight up
  angle[22] =
      1.5 * M_PI + 247 * (M_PI / 180);  // top of the circle// straight up
  angle[23] =
      1.5 * M_PI + 258 * (M_PI / 180);  // top of the circle// straight up
  angle[24] =
      1.5 * M_PI + 270 * (M_PI / 180);  // top of the circle// straight up
  angle[25] =
      1.5 * M_PI + 281 * (M_PI / 180);  // top of the circle// straight up
  angle[26] =
      1.5 * M_PI + 292 * (M_PI / 180);  // top of the circle// straight up
  angle[27] =
      1.5 * M_PI + 302 * (M_PI / 180);  // top of the circle// straight up
  angle[28] =
      1.5 * M_PI + 315 * (M_PI / 180);  // top of the circle// straight up
  angle[29] =
      1.5 * M_PI + 326 * (M_PI / 180);  // top of the circle// straight up
  angle[30] =
      1.5 * M_PI + 337 * (M_PI / 180);  // top of the circle// straight up
  angle[31] =
      1.5 * M_PI + 348 * (M_PI / 180);  // top of the circle// straight up
}
